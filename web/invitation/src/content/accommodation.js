export const accommodation = {
  es: {
          ...
          guestOption: {
            ...
            planCardPerPerson: "A pagar para {name}",
            planCardSaleLabel: "Cubierto por los novios",
            planCardGroupTotal: "A pagar para el grupo",
  ...
  fr: {
          ...
          guestOption: {
            ...
            planCardPerPerson: "Participation aux frais pour {name}",
            planCardSaleLabel: "Pris en charge par les mariés",
            planCardGroupTotal: "Participation aux frais pour le groupe",
  ...
  en: {
          ...
          guestOption: {
            ...
            planCardPerPerson: "To pay for {name}",
            planCardSaleLabel: "Covered by the couple",
            planCardGroupTotal: "To pay for the group",
