...
export const content = {
  es: {
    ...
    guisos: {
      ...
      reorderError: "No se pudo guardar tu orden",
    ...
    music: {
      ...
      genreVote: {
        label: "Califica este género",
        star: "estrella",
        vote: "voto",
        votes: "votos",
        empty: "Sé el primero en calificar",
        yourRating: "Tu calificación",
        error: "No se pudo guardar tu calificación",
      },
      genreSurvey: {
        intro: "Califica la música que amas para que armemos la playlist perfecta.",
        searchLabel: "Busca un género",
        searchPlaceholder: "p. ej. mariachi, kolo, cumbia…",
        searching: "Buscando…",
  ...
  fr: {
    ...
    guisos: {
      ...
      reorderError: "Impossible d’enregistrer ton classement",
    ...
    music: {
      ...
      genreSurvey: {
        intro: "Note la musique que tu aimes pour que nous composions la playlist parfaite.",
        searchLabel: "Recherche un genre",
        searchPlaceholder: "p. ex. mariachi, kolo, cumbia…",
        searching: "Recherche…",
  ...
  en: {
    ...
    guisos: {
      ...
      reorderError: "Could not save your ranking",
    ...
    music: {
      ...
      genreSurvey: {
        intro: "Rate the music you love so we can build the perfect playlist.",
        searchLabel: "Search a genre",
        searchPlaceholder: "e.g. mariachi, kolo, cumbia…",
        searching: "Searching…",
