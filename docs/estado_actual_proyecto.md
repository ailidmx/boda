# Estado Actual del Proyecto / Etat actuel du projet

## ES - Donde estamos hoy
- Venue y alojamiento base confirmados en Roca Azul.
- Flujo de fin de semana definido con arranque viernes y petanca.
- Comida y musica ya tienen estructura operativa y backlog dedicado.
...
- Deroule du week-end defini avec lancement vendredi et petanque.
- Repas et musique ont deja une structure operationnelle et un backlog dedie.
...
2. Cerrar puzzle de vestuario novios.
3. Confirmar contactos taquiza y tejuino.
4. Cerrar distribucion horaria musical.
5. Definir copy final de costos para invitados.
6. Llevar preguntas puzzle de open a decided.

## FR - Focus immediat
1. Completer billet, hebergements et transferts de Dimitar comme premier cas du systeme voyageurs.
2. Clore le puzzle vestimentaire des maries.
3. Confirmer contacts taquiza et tejuino.
4. Clore la repartition horaire musicale.
5. Definir le texte final des couts invites.
6. Faire passer les questions puzzle de open a decided.
