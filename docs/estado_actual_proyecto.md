...
2. Confirmar contactos taquiza y tejuino.
3. Cerrar distribucion horaria musical.
4. Definir copy final de costos para invitados.
5. Llevar preguntas puzzle de open a decided.

## FR - Focus immediat
1. Clore le puzzle vestimentaire des maries.
2. Confirmer contacts taquiza et tejuino.
3. Clore la repartition horaire musicale.
4. Definir le texte final des couts invites.
5. Faire passer les questions puzzle de open a decided.
